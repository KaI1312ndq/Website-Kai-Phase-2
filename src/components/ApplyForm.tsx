...
export default function ApplyForm() {
  ...
  if (state === "success") {
    return (
      <div className="rounded-2xl p-10 text-center" style={{ background: "linear-gradient(180deg, var(--dg-50), var(--db-85))", border: "1px solid rgba(74,214,255,0.35)", boxShadow: "0 24px 60px rgba(20,110,245,0.25)" }}>
  ...
  return (
    <div className="rounded-2xl p-7 md:p-8" style={{ background: "linear-gradient(180deg, var(--dg-50), var(--db-85))", border: "1px solid var(--st-10)", boxShadow: "0 24px 60px rgba(5,10,31,0.55)" }}>
      <div className="flex flex-col gap-5">
        ...
        <p className="text-center text-[0.78rem]" style={{ color: "var(--st-50)" }}>
