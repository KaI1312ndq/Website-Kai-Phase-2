...
export const DARK_TRIAD_QUESTIONS: QuizQuestion[] = [
  ...
  { id: 5, text: "Đôi khi tôi chấp nhận làm cách không hay - miễn đạt được mục đích.", options: LIKERT_POS("MA") },
  ...
  { id: 13, text: "Tôi yêu cầu người khác tôn trọng mình đúng mức.", options: LIKERT_POS("NA") },
