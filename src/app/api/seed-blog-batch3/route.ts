...
const POST_THUE_NGUONG = {
  ...
  body: [
    ...
    p("thuexh3a2", [{ text: "Bước 3:", bold: true }, { text: " Kế toán cập nhật giảm trừ vào bảng lương từ tháng tiếp theo. Nếu nộp muộn, hoàn thuế vào quyết toán cuối năm." }]),
...
const POST_NONMALL = {
  ...
  excerpt: "Shopee Non-Mall 2026 có phí hoa hồng dao động 7-13% tùy ngành hàng, thấp hơn Mall 3-5%. Bài này tổng hợp bảng phí đầy đủ Non-Mall từng ngành, cộng với phí giao dịch, Voucher Xtra mới 5.5%, và Pi Ship 1.600đ (Non-Mall giữ nguyên, Mall tăng lên 2.700đ).",
  ...
  seoDescription: "Bảng phí hoa hồng Shopee Non-Mall 2026: Beauty 8-10%, Fashion 8-10%, Sức Khỏe 10-12%, Electronics 5-7%. Cộng phí giao dịch 6%, Voucher Xtra 5.5%, Pi Ship 1.600đ Non-Mall (Mall 2.700đ).",
  body: [
    ...
    p("b3", [{ text: "2. Phí tự chọn (opt-in):", bold: true }, { text: " Voucher Xtra 5.5% trên doanh thu sau seller voucher (tăng từ 4% ngày 23/05/2026) + Pi Ship 1.600đ/đơn (Non-Mall giữ nguyên; Mall tăng lên 2.700đ từ 23/05/2026)." }]),
    b("b4", "blockquote", "Nếu đăng ký cả Voucher Xtra và Pi Ship: tổng phí opt-in = 5.5% doanh thu thực + 1.600đ. Trên sản phẩm 300.000đ (không seller voucher): 16.500đ + 1.600đ = 18.100đ thêm vào mỗi đơn."),
    ...
    b("meb1", "normal", "Mẹ & Bé là ngành tăng trưởng ổn định trên Shopee. Phí vừa phải, nhưng đặc thù ngành là review quan trọng - nhiều seller cần đầu tư seeding ban đầu."),
    ...
    p("j6", [{ text: "Pi Ship:", bold: true }, { text: " 1.600đ (Non-Mall giữ nguyên)" }]),
    p("j7", [{ text: "Tổng phí sàn: 64.525đ (21.5% giá bán)", bold: true }]),
...
const POST_COMPARE = {
  ...
  body: [
    ...
    p("compxh2a2", [{ text: "TikTok Non-Mall Electronics:", bold: true }, { text: " Hoa hồng 11.5% + giao dịch 6% = tổng ~18.4%." }]),
    p("compxh3a2", [{ text: "Kết luận: Shopee rẻ hơn đáng kể ~4-6% cho Electronics. Shopee vẫn là sàn tốt hơn cho Electronics về chi phí.", bold: true }]),
