...
export default async function OG() {
  return new ImageResponse(
    (
      ...
      >
        <div style={{ position: "absolute", top: "-15%", right: "-5%", width: "560px", height: "560px", borderRadius: "50%", background: "radial-gradient(circle, rgba(74,214,255,0.40), transparent 65%)", display: "flex" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ fontSize: "92px", fontWeight: 800, lineHeight: 1.0, letterSpacing: "-0.035em", display: "flex", flexDirection: "column" }}>
            <span style={{ color: "white" }}>TikTok Shop &</span>
            <span style={{ background: "linear-gradient(120deg, #4ad6ff 0%, #146ef5 50%, #7a3dff 100%)", backgroundClip: "text", color: "transparent" }}>Shopee.</span>
          </div>
          <div style={{ fontSize: "26px", fontWeight: 500, color: "rgba(255,255,255,0.7)", letterSpacing: "-0.01em" }}>
            So sánh Mall vs Non-Mall · 4 phương án song song
          </div>
        </div>

        {/* Bottom - feature chips */}
        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
          {["Phí 2026", "Voucher Extra Plus", "SFR · Pi Ship", "P&L 1 đơn", "Miễn phí"].map((t) => (
            <div key={t} style={{
              padding: "12px 22px",
              borderRadius: "10px",
