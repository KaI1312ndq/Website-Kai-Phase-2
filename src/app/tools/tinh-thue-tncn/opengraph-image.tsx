  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: "absolute", bottom: "-20%", left: "-10%", width: "550px", height: "550px", borderRadius: "50%", background: "radial-gradient(circle, rgba(20,110,245,0.40), transparent 65%)", display: "flex" }} />
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "inline-flex", padding: "10px 18px", borderRadius: "8px", background: "rgba(95,255,170,0.12)", border: "1px solid rgba(95,255,170,0.35)", fontSize: "16px", fontWeight: 700, color: "#5fffaa", letterSpacing: "0.14em", textTransform: "uppercase" }}>
            Tool · Miễn phí
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ fontSize: "76px", fontWeight: 800, lineHeight: 1.0, letterSpacing: "-0.035em", display: "flex", flexDirection: "column" }}>
            <span style={{ color: "white" }}>So sánh thuế</span>
